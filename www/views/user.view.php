    ...
    <div class="admin-users__main">
        ...
        <div class="admin-users__main__search-add-user">
          ...
          <div class="admin-users__main__search-add-user__search">
            ...
            <a class="button button--green admin-users__main__search-add-user__search__button" >Chercher</a>
          </div>
          <a class="button button--green admin-users__main__search-add-user__add-user " >Ajouter utilisatuer</a>
        </div>
