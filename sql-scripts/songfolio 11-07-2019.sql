...
--
-- Hôte : database
-- Généré le :  jeu. 11 juil. 2019 à 16:06
...
(4, 'config', '{\"Port\": \"test\", \"fb_url\": \"qsdqs\", \"insta_url\": \"link\", \"site_desc\": \"test\", \"site_name\": \"MAPAGE\", \"site_tags\": \"test\", \"smtp_mail\": \"test\", \"SMTPSecure\": \"test\", \"twitter_url\": \"link/instagram\", \"username_mail\": \"test\", \"oauth_id_Facebook\": \"2232449167069840\", \"userpassword_mail\": \"test\", \"oauth_secret_Facebook\": \"ec07adea3bce25a26d3fdcb3b5baa5f2\"}'),
(8, 'mail', '{\"Port\": \"465\", \"smtp_mail\": \"smtp.gmail.com\", \"SMTPSecure\": \"ssl\", \"username_mail\": \"songfolioweb@gmail.com\", \"userpassword_mail\": \"Followthesong\"}');
...
CREATE TABLE `Users` (
  ...
  `pwd_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `Users` (`id`, `username`, `first_name`, `last_name`, `email`, `password`, `date_inserted`, `role_id`, `status`, `date_update`, `login_token`, `id_facebook`, `pwd_token`, `pwd_date`) VALUES
(8, 'Test', 'qsd', 'qsd', 'ivan.naluzhnyi@gmail.com', '$2y$10$4cyg2G11ZL8rnzj253VnleSSevdZeCk4h96n8pOP/XOPDqkN.jWAS', '2019-05-21 17:20:08', 4, 0, NULL, '227de67949fef05edf1aaffc492ffc9b', NULL, '', NULL),
(10, 'Admin', 'Ivan', 'Naluzhnyi', 'ivan.naluzhnyi@gmail.com', '$2y$10$o3RVvIqVK79u6elgBego0Ol0MbY3HX7h/z1YxBm/EXhGFtNDcV08G', '2019-05-21 17:20:08', 1, 0, NULL, '8ba9c475f7aa632bb3dcdb9c9c21c770', NULL, '', NULL),
(11, 'Adminssdffsfqsdsd', 'Ivanqsdqds', 'Naluzhnyiqsdqds', 'ivan.naluzhnyi@gmail.com', '$2y$10$UtxDzLtbmfAS/j9DnKa50OV5.PpPgoJmmHsDwD2sz4NcK2yEi88A6', '2019-05-21 17:20:08', 1, 0, NULL, '377855b244ab32cd7ceb960bd8166cd5', NULL, '', NULL),
(12, 'Comm', 'azer', 'azer', 'ivan.naluzhnyi@gmail.com', '$2y$10$19zDWeebOgnx7XglWiSCW.7ymAawXmQKmKtF7.0N4e70kfeMqjUju', '2019-05-21 17:20:08', 5, 0, NULL, '6631f03ca5a047345a528baf047e8abf', NULL, '', NULL);
